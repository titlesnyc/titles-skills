...
| [`style-explorer`](./skills/style-explorer/SKILL.md) | Roam the artist library — a wide, varied spread across many artists and prompts to discover styles, then point at where to go deeper |
